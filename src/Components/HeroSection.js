...
const HeroSection = () => {
    ...
    return (
        <div style={{ textColor:`${currentTheme.textColor}`,
        ...
        border: `${currentTheme.border}`,textAlign:"center",padding:"15px"}}>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                Nunc eget urna ac nisl iaculis vulputate non in ligula. Nullam aliquet ullamcorper sagittis.
                Aliquam maximus, eros vitae efficitur mattis, lectus mi laoreet lacus, nec sodales 
